...
Version  : 3.3.3
Release  : 20
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/spatstat.model_3.3-3.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/spatstat.model_3.3-3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732115106
