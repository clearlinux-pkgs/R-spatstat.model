...
Version  : 3.3.6
Release  : 23
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/spatstat.model_3.3-6.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/spatstat.model_3.3-6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748011419
