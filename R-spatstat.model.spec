...
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/spatstat.model_3.3-5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742763080
...
/usr/lib64/R/library/spatstat.model/info/packagesizes.txt
